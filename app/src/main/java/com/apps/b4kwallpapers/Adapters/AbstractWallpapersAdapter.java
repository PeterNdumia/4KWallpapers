...
public class AbstractWallpapersAdapter extends RecyclerView.Adapter<AbstractWallpapersAdapter.ImageViewHolder> {
    private Context mContext;
    private List<AbstractUpload> mUploads;
    private Bitmap bitmapImage;
    private AbstractWallpapers abstractWallpapers;





    public AbstractWallpapersAdapter (Context context, List<AbstractUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    ...
    @NonNull
    @Override
    public AbstractWallpapersAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {

        View v = LayoutInflater.from(mContext).inflate(R.layout.abstract_recycler, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull AbstractWallpapersAdapter.ImageViewHolder holder, int position) {
        AbstractUpload uploadCurrent = mUploads.get(position);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_view_abstract);

            buttonShare = itemView.findViewById(R.id.abstractbuttonShare);
            buttonDownload = itemView.findViewById(R.id.abstractbuttonSave);
            buttonSetAs = itemView.findViewById(R.id.abstractbuttonSet);
            buttonUp = itemView.findViewById(R.id.abstractbuttonup);
    ...
    private void abstractUpOnclick(View view) {
    ...
    private void shareWallpaper(AbstractUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final AbstractUpload wallpaper){
    ...
    private Uri saveWallpaperAndGetUri(Bitmap bitmap, String mName){

        if(checkSelfPermission(mContext, Manifest.permission.WRITE_EXTERNAL_STORAGE)
        ...
        File folder = new File(Environment.getExternalStorageDirectory().toString()+"/4K_Wallpapers");
        folder.mkdirs();

        File file = new File(folder, mName + ".jpg");
    ...
    private void setWallpaper(AbstractUpload wallset)
    {
