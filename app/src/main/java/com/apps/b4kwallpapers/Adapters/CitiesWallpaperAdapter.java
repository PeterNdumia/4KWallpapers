...
public class CitiesWallpaperAdapter extends RecyclerView.Adapter<CitiesWallpaperAdapter.ImageViewHolder>{

    private Context mContext;
    private List<CitiesUpload> mUploads;
    private Bitmap bitmapImage;

    public CitiesWallpaperAdapter (Context context, List<CitiesUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    @NonNull
    @Override
    public CitiesWallpaperAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.cities_recycler, parent, false);
        return new CitiesWallpaperAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull CitiesWallpaperAdapter.ImageViewHolder holder, int position) {
        CitiesUpload uploadCurrent = mUploads.get(position);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_view_cities);

            buttonShare = itemView.findViewById(R.id.citiesbuttonShare);
            buttonDownload = itemView.findViewById(R.id.citiesbuttonSave);
            buttonSetAs = itemView.findViewById(R.id.citiesbuttonSet);
            buttonUp =itemView.findViewById(R.id.citiesbuttonup);
    ...
    private void citiesUpOnclick(View view) {
    ...
    private void shareWallpaper(CitiesUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final CitiesUpload wallpaper){
    ...
    private void setWallpaper(CitiesUpload wallset)
    {
