...
import com.apps.b4kwallpapers.UploadPages.DoubleExposureUpload;
...
public class DoubleExposureWallpaperAdapter extends RecyclerView.Adapter<DoubleExposureWallpaperAdapter.ImageViewHolder>{

    private Context mContext;
    private List<DoubleExposureUpload> mUploads;
    private Bitmap bitmapImage;

    public DoubleExposureWallpaperAdapter (Context context, List<DoubleExposureUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    @NonNull
    @Override
    public DoubleExposureWallpaperAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.doubleexposure_recycler, parent, false);
        return new DoubleExposureWallpaperAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull DoubleExposureWallpaperAdapter.ImageViewHolder holder, int position) {
        DoubleExposureUpload uploadCurrent = mUploads.get(position);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_view_doubleexposure);

            buttonShare = itemView.findViewById(R.id.doubleexposurebuttonShare);
            buttonDownload = itemView.findViewById(R.id.doubleexposurebuttonSave);
            buttonSetAs = itemView.findViewById(R.id.doubleexposurebuttonSet);
            buttonUp = itemView.findViewById(R.id.debuttonup);
    ...
    private void deUpOnclick(View view) {
    ...
    private void shareWallpaper(DoubleExposureUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final DoubleExposureUpload wallpaper){
    ...
    private void setWallpaper(DoubleExposureUpload wallset)
    {
