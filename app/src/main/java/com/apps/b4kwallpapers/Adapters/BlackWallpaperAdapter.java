...
import com.apps.b4kwallpapers.UploadPages.BlackUpload;
...
public class BlackWallpaperAdapter extends RecyclerView.Adapter<BlackWallpaperAdapter.ImageViewHolder>{
    private Context mContext;
    private List<BlackUpload> mUploads;
    private Bitmap bitmapImage;

    public BlackWallpaperAdapter (Context context, List<BlackUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    @NonNull
    @Override
    public BlackWallpaperAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.black_recycler, parent, false);
        return new BlackWallpaperAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull BlackWallpaperAdapter.ImageViewHolder holder, int position) {
        BlackUpload uploadCurrent = mUploads.get(position);
    ...
    public ImageViewHolder(@NonNull View itemView) {
        ...
        imageView = itemView.findViewById(R.id.image_view_black);

        buttonShare = itemView.findViewById(R.id.blackbuttonShare);
        buttonDownload = itemView.findViewById(R.id.blackbuttonSave);
        buttonSetAs = itemView.findViewById(R.id.blackbuttonSet);
        buttonUp = itemView.findViewById(R.id.blackbuttonup);
    ...
    private void blackUpOnclick(View view) {
    ...
    private void shareWallpaper(BlackUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final BlackUpload wallpaper){
    ...
    private void setWallpaper(BlackUpload wallset)
    {
