...
public class PyroWallpaperAdapter extends RecyclerView.Adapter<PyroWallpaperAdapter.ImageViewHolder> {
    private Context mContext;
    private List<PyroUpload> mUploads;
    private Bitmap bitmapImage;

    public PyroWallpaperAdapter (Context context, List<PyroUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    @NonNull
    @Override
    public PyroWallpaperAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.pyro_recycler, parent, false);
        return new PyroWallpaperAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull PyroWallpaperAdapter.ImageViewHolder holder, int position) {
        PyroUpload uploadCurrent = mUploads.get(position);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_view_pyro);

            buttonShare = itemView.findViewById(R.id.pyrobuttonShare);
            buttonDownload = itemView.findViewById(R.id.pyrobuttonSave);
            buttonSetAs = itemView.findViewById(R.id.pyrobuttonSet);
            buttonUp = itemView.findViewById(R.id.pyrobuttonup);
    ...
    private void pyroUpOnclick(View view) {
    ...
    private void shareWallpaper(PyroUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final PyroUpload wallpaper){
    ...
    private void setWallpaper(PyroUpload wallset)
    {
