...
import com.apps.b4kwallpapers.UploadPages.AnimalsUpload;
...
public class AnimalWallpapersAdapter extends RecyclerView.Adapter<AnimalWallpapersAdapter.ImageViewHolder> {
    private Context mContext;
    private List<AnimalsUpload> mUploads;
    private Bitmap bitmapImage;

    public AnimalWallpapersAdapter (Context context, List<AnimalsUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    @NonNull
    @Override
    public AnimalWallpapersAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.animals_recycler, parent, false);
        return new AnimalWallpapersAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AnimalWallpapersAdapter.ImageViewHolder holder, int position) {
        AnimalsUpload uploadCurrent = mUploads.get(position);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_view_animals);

            buttonShare = itemView.findViewById(R.id.animalsbuttonShare);
            buttonDownload = itemView.findViewById(R.id.animalsbuttonSave);
            buttonSetAs = itemView.findViewById(R.id.animalsbuttonSet);
            buttonUp = itemView.findViewById(R.id.animalbuttonup);
    ...
    private void animalUpOnclick(View view) {
    ...
    private void shareWallpaper(AnimalsUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final AnimalsUpload wallpaper){
    ...
    private void setWallpaper(AnimalsUpload wallset)
    {
        Glide.with(mContext)
                .asBitmap()
