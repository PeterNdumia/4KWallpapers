...
public class PatternsWallpaperAdapter extends RecyclerView.Adapter<PatternsWallpaperAdapter.ImageViewHolder>  {
    private Context mContext;
    private List<PatternsUpload> mUploads;
    private Bitmap bitmapImage;

    public PatternsWallpaperAdapter(Context context, List<PatternsUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    @NonNull
    @Override
    public PatternsWallpaperAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.patterns_recycler, parent, false);
        return new PatternsWallpaperAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull PatternsWallpaperAdapter.ImageViewHolder holder, int position) {
        PatternsUpload uploadCurrent = mUploads.get(position);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_view_patterns);

            buttonShare = itemView.findViewById(R.id.patternsbuttonShare);
            buttonDownload = itemView.findViewById(R.id.patternsbuttonSave);
            buttonSetAs = itemView.findViewById(R.id.patternsbuttonSet);
            buttonUp = itemView.findViewById(R.id.patternsbuttonup);
    ...
    private void patternsUpOnclick(View view) {
    ...
    private void shareWallpaper(PatternsUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final PatternsUpload wallpaper){
    ...
    private void setWallpaper(PatternsUpload wallset)
    {
