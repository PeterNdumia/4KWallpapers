...
import com.apps.b4kwallpapers.UploadPages.CreepyUpload;
...
public class CreepyWallpaperAdapter extends RecyclerView.Adapter<CreepyWallpaperAdapter.ImageViewHolder>{
    private Context mContext;
    private List<CreepyUpload> mUploads;
    private Bitmap bitmapImage;

    public CreepyWallpaperAdapter (Context context, List<CreepyUpload> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    @NonNull
    @Override
    public CreepyWallpaperAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int ViewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.creepy_recycler, parent, false);
        return new CreepyWallpaperAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        CreepyUpload uploadCurrent = mUploads.get(position);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_view_creepy);

            buttonShare = itemView.findViewById(R.id.creepybuttonShare);
            buttonDownload = itemView.findViewById(R.id.creepybuttonSave);
            buttonSetAs = itemView.findViewById(R.id.creepybuttonSet);
            buttonUp = itemView.findViewById(R.id.creepybuttonup);
    ...
    private void creepyUpOnclick(View view) {
    ...
    private void shareWallpaper(CreepyUpload uploadCurrent) {
    ...
    private void downloadWallpaper(final CreepyUpload wallpaper){
    ...
    private void setWallpaper(CreepyUpload wallset)
    {
